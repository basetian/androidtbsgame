...
public class Unit {
	...
	/**
	 * Move to another scenery tile.
	 * 
	 * @param tile
	 */
	public void moveTo(SceneryTile tile) {
		this.movementBehaviour.moveTo(tile);
		final int movementCosts =  this.movementBehaviour.getCostsOfMoving();
		this.actionPoints -= this.actionPointBehavior.spendActionPoints(movementCosts);
	}
	...
	public void attack(Unit enemyUnit) {
		...
		this.actionPoints -= this.actionPointBehavior.spendActionPoints(attackCosts);
	}
